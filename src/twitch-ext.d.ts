...
interface TwitchExt {
	 ...
	 * @see https://dev.twitch.tv/docs/extensions/reference/#onauthorized-functionauthcallback
	 */
	 ...
	 * @see https://dev.twitch.tv/docs/extensions/reference/#oncontext-functioncontextcallback
	 */
	onContext(
		contextCallback: (
	 ...
	 * @see https://dev.twitch.tv/docs/extensions/reference/#onerror-functionerrorcallback
	 */
	 ...
	 * @see https://dev.twitch.tv/docs/extensions/reference/#onpositionchangedcallback
	 */
	onPositionChanged(
	 ...
	 * @see https://dev.twitch.tv/docs/extensions/reference/#onvisibilitychangedcallback
	 */
	onVisibilityChanged(
		callback:
			| ((isVisible: false) => void)
			| ((isVisible: true, context: TwitchExtContext) => void),
	): void;
	 ...
	 * @see https://dev.twitch.tv/docs/extensions/reference/#send-functiontarget-contenttype-message
	 */
	 ...
	 * @see https://dev.twitch.tv/docs/extensions/reference/#listen-functiontarget-callback
	 */
	listen(
		target: string,
	 ...
	 * @param target Target topic. Often this is "broadcast" but it might be "whisper-<userId>".
	 * @param callback These fields correspond to the values in the send() message, except the message is always a string.
	 * @see https://dev.twitch.tv/docs/extensions/reference/#unlisten-functiontarget-callback
	 */
	unlisten(
		target: string,
		callback: (target: string, contentType: string, message: string) => void,
